...
@section('content')
<h1>Registrar Examenes </h1>
@if ($message = Session::get('success'))
    <div class="alert alert-success">
         <p>{{ $message }}</p>
    </div>
@endif
{!! Form::open(array('route' => 'examen.store','method'=>'POST')) !!}
    ...
    <div class="form-group" id="capa_subgrupo"><br><br>
		...
		<div class="col-xs-2">
		    <a class="form-control" id="registrar_subgrupo" name="registrar_subgrupo">Registrar subgrupo</a>
		</div>
    </div>
    <div class="form-group" id="capa_descripcionsubgrupo"><br><br>
	    ...
	    <div class="col-xs-3">
		    <a class="form-control" id="no_registrar_subgrupo" name="no_registrar_subgrupo">Ya existe el subgrupo</a>
		</div>
	</div>
